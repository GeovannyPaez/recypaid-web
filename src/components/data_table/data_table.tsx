...
export interface SelectWithSearchConfig {
  endpoint: string
  placeholder?: string
  searchParamKey: string
  maperOptions: (item: any) => { value: string; label: string }
  label?: string
  clearable?: boolean
  clearLabel?: string
  dependsOn?: string[] // Array de searchParamKeys de los que depende
  additionalParams?: Record<string, string> // Parámetros adicionales estáticos
}
